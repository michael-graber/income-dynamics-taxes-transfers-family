...
foreach skills in lowskill mediumskill highskill  {
	...
	* Market Income
	graph twoway (line var_delta_y       age if income == "market" & education == "`skills'" & age <= 58) ///
		  || (line var_delta_y_model age if income == "market" & education == "`skills'" & age <= 58),  plotregion(lcolor(black)) graphregion(color(white)) bgcolor(white) ///
	xlabel(25 (5) 55) ///
	ylabel(0 (.1) .4, nogrid) ///
	xtitle("age")  ///
	...
	* Disposable Income
	graph twoway (line var_delta_y       age if income == "disposable" & education == "`skills'" & age <= 58) ///
		  || (line var_delta_y_model age if income == "disposable" & education == "`skills'" & age <= 58),  plotregion(lcolor(black)) graphregion(color(white)) bgcolor(white) ///
	xlabel(25 (5) 55) ///
	ylabel(0 (.1) .4, nogrid) ///
	xtitle("age")  ///
	ytitle("var({&Delta}y{subscript:i,a})") ///
	...
	* Disposable Family Income
	graph twoway (line var_delta_y       age if income == "disposable(family)" & education == "`skills'" & age <= 58) ///
		  || (line var_delta_y_model age if income == "disposable(family)" & education == "`skills'" & age <= 58),  plotregion(lcolor(black)) graphregion(color(white)) bgcolor(white) ///
	xlabel(25 (5) 55) ///
	ylabel(0 (.1) .4, nogrid) ///
	xtitle("age")  ///
	ytitle("var({&Delta}y{subscript:i,a})") ///
	...
	* Market Income
	graph twoway (line cov_delta_y       age if income == "market" & education == "`skills'" & age <= 58) ///
		  || (line cov_delta_y_model age if income == "market" & education == "`skills'" & age <= 58),  plotregion(lcolor(black)) graphregion(color(white)) bgcolor(white) ///
	xlabel(25 (5) 55) ///
	ylabel(-.1 (.025) 0, nogrid) ///
	xtitle("age")  ///
	...
	* Disposable Income
	graph twoway (line cov_delta_y       age if income == "disposable" & education == "`skills'" & age <= 58) ///
		  || (line cov_delta_y_model age if income == "disposable" & education == "`skills'" & age <= 58),  plotregion(lcolor(black)) graphregion(color(white)) bgcolor(white) ///
	xlabel(25 (5) 55) ///
	ylabel(-.1 (.025) 0, nogrid) ///
	xtitle("age")  ///
	ytitle("cov({&Delta}y{subscript:i,a},{&Delta}y{subscript:i,a+1})") ///
	...
	* Disposable Family Income
	graph twoway (line cov_delta_y       age if income == "disposable(family)" & education == "`skills'" & age <= 58) ///
		  || (line cov_delta_y_model age if income == "disposable(family)" & education == "`skills'" & age <= 58),  plotregion(lcolor(black)) graphregion(color(white)) bgcolor(white) ///
	xlabel(25 (5) 55) ///
	ylabel(-.1 (.025) 0, nogrid) ///
	xtitle("age")  ///
	ytitle("cov({&Delta}y{subscript:i,a},{&Delta}y{subscript:i,a+1})") ///
