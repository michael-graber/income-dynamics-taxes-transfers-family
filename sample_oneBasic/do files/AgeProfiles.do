...
* save current dataset as work_1basic_sample sample 
...
graph twoway  (line imarket_age age if education == `edu') ///
	...
	legend(order( 1 "Market Income" 2 "Disposable Income" 3 "Disposable Income (Family)"))
